...
const PostItem = ({ post, upVotePost, downVotePost }) => (
  <li className="list-group-item" key={post.id}>
    <div className="mt-2 mb-2 d-flex justify-content-between"><span>Score: {post.voteScore}</span><span>{new Date(post.timestamp).toDateString()}</span><div><a href="">edit</a> <a href="">delete</a></div></div>
